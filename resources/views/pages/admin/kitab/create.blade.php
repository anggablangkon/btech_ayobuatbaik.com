...
@section('title', 'Tambah Kitab - ' . site_name())
...
@section('content')
    <div class="p-6">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mt-2">Tambah Kitab Baru</h1>
        </div>

        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl">
            <form action="{{ route('admin.kitab.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent"
                                  placeholder="Deskripsi singkat tentang kitab...">{{ old('description') }}</textarea>
