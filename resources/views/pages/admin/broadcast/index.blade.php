                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.broadcast.destroy', $broadcast) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus broadcast ini?')">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 relative">
                ...
                <div class="border-t border-gray-100 pt-3 flex justify-between items-center">
                    <form action="{{ route('admin.broadcast.destroy', $broadcast) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus broadcast ini?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-sm font-medium text-red-500 hover:text-red-700 flex items-center gap-2 px-3 py-1.5 hover:bg-red-50 rounded-lg transition-colors">
